...
export class CadastroComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.tipos = [Tipo.INICIO_TRABALHO, Tipo.INICIO_ALMOCO, Tipo.TERMINO_ALMOCO, Tipo.TERMINO_TRABALHO];
  }
  ...
  obterLancamento(dados: any): Lancamento{
    ...
    return new Lancamento(data.format('YYYY-MM-DD HH:mm:ss'), dados.tipo, '', this.funcionarioId );
  }
